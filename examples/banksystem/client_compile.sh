...
~/aspectj1.8/bin/ajc -1.8 -cp ../../aspectjrt.jar -sourceroots ./clientbuild

echo weaving aspects into the JAR...
cp -r aspects ./clientbuild
~/aspectj1.8/bin/ajc -1.8 -cp ../../aspectjrt.jar:./clientbuild -outxmlfile ./clientbuild/META-INF/aop.xml ./clientbuild/aspects/*.aj
