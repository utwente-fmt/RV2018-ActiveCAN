...
~/aspectj1.8/bin/ajc -1.8 -cp ../../aspectjrt.jar -sourceroots ./serverbuild

echo weaving aspects into the JAR...
cp -r aspects ./serverbuild
~/aspectj1.8/bin/ajc -1.8 -cp ../../aspectjrt.jar:./serverbuild -outxmlfile ./serverbuild/META-INF/aop.xml ./serverbuild/aspects/*.aj
